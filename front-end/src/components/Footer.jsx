      ...
      <div className="container container--footer">
        <div className="diferenciais">
          <div className="diferencial">
            ...
            />
            <h2 className="diferencial_h2">Escolha como pagar</h2>
            <p>
          ...
          <div className="diferencial">
            <img
              ...
              alt="imagem do cartão"
            />
            <h2 className="diferencial_h2">Frete grátis a partir de R$ 19</h2>
            <p>
          ...
          <div className="diferencial">
            <img
              ...
              alt="imagem do cartão"
            />
            <h2 className="diferencial_h2">Segurança, do início ao fim</h2>
            <p>
