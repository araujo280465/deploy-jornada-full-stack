...
const Carrinho = () => {
  ...
  const fecharPedido = async () => {
    const { data } = await axios.post("http://localhost:3000/pedido", {
        ...
        <>
                ...
                <div className="carrinho__quantidade">
                  <div className="carrinho__icone-qtd">
                    <p
                      ...
                      onClick={() => removerProdutoCarrinho(1, produto)}
                    >
                      -
                    </p>
                    <p>{quantidade}</p>
                    <p
                      className="carrinho__sinal"
                      onClick={() => adicionarProdutoCarrinho(1, produto)}
                    >
                      +
                    </p>
                  </div>
                  <p>
                    R$ {(quantidade * produto.precoDesconto).toLocaleString()}
                  </p>
                  <svg
                    ...
                    strokeWidth="1.5"
                    stroke="currentColor"
                    onClick={() => removerProdutoCarrinho(quantidade, produto)}
                  >
                    <path
                      strokeLinecap="round"
          ...
          <div className="carrinho__pedido">
            <p>
              ...
              {valorTotalCarrinho.toLocaleString()}
            </p>
